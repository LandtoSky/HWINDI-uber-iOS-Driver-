...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    arrListName=[[NSMutableArray alloc]initWithObjects:NSLocalizedString(@"PROFILE",nil),NSLocalizedString(@"History",nil),NSLocalizedString(@"Settings",nil),NSLocalizedString(@"Share",nil),nil];
    
    arrImages=[[NSMutableArray alloc]initWithObjects:@"menu_profile",@"menu_ride_history",@"nav_referral",@"nav_share",nil];
    ...
    [arrListName addObject:NSLocalizedString(@"SIGN_OUT", nil)];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([[arrListName objectAtIndex:indexPath.row]isEqualToString:NSLocalizedString(@"SIGN_OUT", nil)])
    {
        UIAlertView *alert=[[UIAlertView alloc]initWithTitle:NSLocalizedString(@"SIGN_OUT", nil)  message:NSLocalizedString(@"WANT_SIGNOUT", nil) delegate:self cancelButtonTitle:NSLocalizedString(@"NO", nil) otherButtonTitles:NSLocalizedString(@"YES", nil), nil];
        alert.tag=100;
        [alert show];
